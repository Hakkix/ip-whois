...
function renderError(msg,ip=''){els.results.innerHTML=`<article class="result-error"><h3>Lookup failed</h3><p>${msg}</p><p><strong>IP:</strong> ${ip}</p><button class="chip" data-reset="1">try another address</button></article>`;}
